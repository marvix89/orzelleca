...
(function(jQuery)
{
	jQuery.fn.awShowcase = function(options)
	{
		...
		function changeContent(id, direction)
		{
                    ...
                    if(id==0){
                       $(".showcase-arrow-previous").hide(0); 
                    }else{
                         $(".showcase-arrow-previous").show(0); 
                    } 
                        if(id==5){
                          $(".showcase-arrow-next").hide(0); 
                    }else{
                         $(".showcase-arrow-next").show(0); 
                    }
		...
		if (options.thumbnails)
		{
			...
			buttonBackward.click(function() { slideThumbnailWrapper('backward', true, true); });
