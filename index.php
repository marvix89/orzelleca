...
<!--        <script type="text/javascript" src="js/jmpress.min.js"></script>
    ...
    <body >
        ...
        <div id="content"  ><div id="homepage">
                ...
                <div class="r_nozze"  onclick="apri_categoria('liste')"></div>
                <div class="r_regali"  onclick="apri_categoria('regali')"></div>
                <a href="https://www.facebook.com/orzelleca.gioielli/" target="_blank"><div class="r_facebook"></div></a>
                <!--<a href="upload/130903_Beileger.pdf" target="_blank"><div class="r_collezione"></div></a>-->
                <!--<div class="right" >-->
